<script lang="ts">
	...
	const provinceMap = {
	  ...
	  oviedo: 'Asturias', aviles: 'Asturias', gijon: 'Asturias',
	  palma: 'Islas Baleares',
	  'las palmas': 'Canarias', 'santa cruz de tenerife': 'Canarias',
	  santander: 'Cantabria',
	  toledo: 'Castilla-La-Mancha', 'ciudad real': 'Castilla-La-Mancha', cuenca: 'Castilla-La-Mancha', guadalajara: 'Castilla-La-Mancha', albacete: 'Castilla-La-Mancha',
	  leon: 'Castilla y León', burgos: 'Castilla y León', zamora: 'Castilla y León', palencia: 'Castilla y León', salamanca: 'Castilla y León', avila: 'Castilla y León', segovia: 'Castilla y León', valladolid: 'Castilla y León', soria: 'Castilla y León',
	  barcelona: 'Cataluña', girona: 'Cataluña', lleida: 'Cataluña', tarragona: 'Cataluña',
	  valencia: 'Comunidad Valenciana', castellon: 'Comunidad Valenciana', alicante: 'Comunidad Valenciana',
	  ...
	  pamplona: 'Navarra',
	  logrono: 'La Rioja',
	  bilbao: 'País Vasco', donostia: 'País Vasco',
	...
	const allCommunities = Object.values(provinceMap) as (typeof provinceMap)[keyof typeof provinceMap][];
	...
	function initChart() {
	  ...
	  const populationTotals = comms.map(c =>
		waterData.reduce((sum, w) =>
		  w.autonomous_community === c ? sum + w.benefited_population : sum
		, 0)
	  );
  ...
  <style>
	main { font-family: sans-serif; margin: 20px auto; max-width: 900px; }
  </style>
