<script>
    ...
    function getParksInIndigenousTerritory() {
        const parksInAndalucia = spanishParks.filter(park => park.autonomous_community === "Andalucía");
    ...
    onMount(async () => {
        ...
        try {
            ...
            await Promise.all([fetchSpanishParks(), fetchAmazighTerritories(), fetchGuancheTerritories()]);
            loading = false;
...
<main>
    ...
    {:else}
        <div class="explanation">
            <p>
                Esta visualización muestra la distribución de parques nacionales españoles según los territorios
                indígenas reconocidos por Native Land Digital. Específicamente, muestra cuántos parques se encuentran
                en territorios históricamente Amazigh (sur de Andalucía) y Guanche (Islas Canarias).
            </p>
        </div>
        ...
        <div class="indigenous-info">
            ...
            <div class="territory-cards">
                <div class="territory-card">
                    <h4>Amazigh</h4>
                    <p>El territorio Amazigh incluye partes del sur de España, particularmente Andalucía, así como el norte de África. Los Amazigh son conocidos también como bereberes.</p>
                    <p>Parques nacionales en este territorio: <strong>{getParksInIndigenousTerritory().amazigh}</strong></p>
                </div>
                <div class="territory-card">
                    <h4>Guanche</h4>
                    <p>Los Guanches fueron los habitantes originarios de las Islas Canarias. Su cultura y lengua tienen raíces bereberes.</p>
                    <p>Parques nacionales en este territorio: <strong>{getParksInIndigenousTerritory().guanche}</strong></p>
                </div>
            </div>
        </div>
        ...
        <div class="sources">
            ...
            <ul>
                ...
                <li>Territorios Indígenas: <a href="https://native-land.ca/resources/api-docs/" target="_blank">Native Land Digital API</a></li>
            </ul>
        </div>
    {/if}
</main>
