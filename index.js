...
app.get(BASE_API + "/forest-fires/loadInitialData", (req, res) => {
    ...
    if (datosAlvaro.length === 0) {
        ...
        let nuevosAccidentesForestales = [
            { year: 2024, comunidad: "Andalucia", number_of_accidents: 10034, percentage_of_large_fires: 0.39 },
            { year: 2024, comunidad: "Aragon", number_of_accidents: 5877, percentage_of_large_fires: 0.59 },
            ...
            { year: 2024, comunidad: "Castilla y Leon", number_of_accidents: 20343, percentage_of_large_fires: 0.47 },
